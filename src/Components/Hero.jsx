...
function Hero() {
    return (
        <div className='md:px-16 font-inter  sm:px-12 px-8 pt-30 xmd:pt-20 flex items-center justify-between bg-gray-200 xmd:flex-row flex-col'>
            <div className='flex-1/3'>
                <p className='text-[#0667ce] font-[600] mb-4'>Online Hiring</p>
                <p className='text-[40px] leading-12 font-[500] md:w-[70%] w-full text-zinc-900 mb-4'>Simple Hiring For Smart Businesses</p>
                ...
                <div className='flex gap-4'>
                    ...
                    <div className='gradient-bg p-[2px] rounded-[8px] inline-block font-inter transition duration-300 cursor-pointer hover:scale-105'>
                        <div className='rounded-[6px] bg-gray-200 py-2 px-4'>
                            Watch A Demo
                        </div>
                    </div>
